...
const LoginPage = () => {
  ...
  return (
    <div className="">
      ...
      <div className="p-4 border bg-black opacity-90 w-96 absolute top-[25%] right-[40%] border-black rounded-2xl">
        <div className="m-2">
          ...
          {
            signIn ?<> <p className="text-white inline">New to Netflix? </p>
          <button
